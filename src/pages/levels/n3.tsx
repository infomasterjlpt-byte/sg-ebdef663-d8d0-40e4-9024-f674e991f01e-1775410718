            ...
            <div className="flex items-center gap-3 justify-center">
              {LEVELS.map((lvl) => (
                <Link key={lvl.id} href={`/levels/${lvl.id}`}>
                  <Button
                    variant={lvl.id === "n3" ? "default" : "outline"}
                    className={lvl.id === "n3" ? "font-bold" : ""}
                    style={lvl.id === "n3" ? { backgroundColor: lvl.color, color: 'white' } : {}}
                  >
                    {lvl.name}
                  </Button>
                </Link>
                  ...
                  >
                    <CardContent className="p-6 text-center space-y-4">
                      ...
                      <Button 
                        ...
                        asChild
                      >
                        <Link href={`/practice?level=N3&category=${category.id}`}>
                          Start {category.name}
                        </Link>
                      </Button>
                    </CardContent>
